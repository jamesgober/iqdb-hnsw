# iqdb-hnsw -- Engineering Directives
...
iqdb-hnsw is the primary approximate nearest-neighbor algorithm for production vector search: sub-millisecond search over millions of vectors. After the types crate, it is the most important crate in the family. Correctness is proven by recall benchmarks against `iqdb-flat`; the goal is to be fast, tunable, and readable enough to follow the algorithm.
